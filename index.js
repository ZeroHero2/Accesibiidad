...
function clickRight() {
  ...
  switch (newValue) {
    case -270:
      ...
      document.querySelector("proyect1-container").setAttribute("aria-hidden", "true");
...
// Valida el formulario antes de mostrar la notificacion
...
function openModal(e) {
  ...
  document.getElementById("modal-header").focus(); //se enfoca en el header del modal
